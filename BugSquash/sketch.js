...
let spriteSheetFilenames = ["NewBug.png"];
let spriteSheets = [];
let animations = [];
...
function reset() {
  ...
  for(let i=0; i < game.totalSprites; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),96,96,random(100,300),random(100,300),9,random(0.5,1),6,random([0,1]));
  }
}
